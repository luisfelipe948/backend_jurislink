...
CREATE TABLE advogados (
    id_advogado INT PRIMARY KEY,           -- mesmo valor do id_usuario
    oab_numero VARCHAR(20) NOT NULL,
    oab_uf CHAR(2) NOT NULL,
    FOREIGN KEY (id_advogado) REFERENCES usuarios (id_usuario) ON DELETE CASCADE
);

CREATE TABLE clientes (
    id_cliente INT PRIMARY KEY,            -- mesmo valor do id_usuario
